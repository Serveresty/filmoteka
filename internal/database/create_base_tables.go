...
func CreateBaseTables() error {
	_, err := DB.Exec(`
	CREATE TABLE IF NOT EXISTS "users_data" (user_id serial PRIMARY KEY, first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, email VARCHAR(255) UNIQUE, phone VARCHAR(255) UNIQUE, password VARCHAR(255) NOT NULL);
